...
CREATE TABLE `tdo_list_settings` (
  ...
  `default_priority` tinyint(4) DEFAULT '0',
...
# Dump of table tdo_meta_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tdo_meta_data`;

CREATE TABLE IF NOT EXISTS `tdo_meta_data` (
  `userid` varchar(36) NOT NULL,
  `organizing` int(10) DEFAULT NULL,
  `prioritizing` int(10) DEFAULT NULL,
  `remembering` int(10) DEFAULT NULL,
